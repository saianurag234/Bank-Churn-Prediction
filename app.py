...
def churn_pred(pred_input):
    ...
    pickled_model = pickle.load(open('https://github.com/saianurag234/Bank-Churn-Prediction/blob/main/model.pkl', 'rb'))
    pickled_scaler = pickle.load(open('https://github.com/saianurag234/Bank-Churn-Prediction/blob/main/scaler.pkl', 'rb'))
